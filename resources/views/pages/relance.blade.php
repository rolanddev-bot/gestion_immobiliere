...
<div class="container-fluid" id="container-wrapper">
   ...
   <script type="application/javascript">
    ...
    <div class="col-lg-12">
        <h2 class="text-center alert alert-secondary">Relance</h2>
              <div class="card mb-4">
   ...
   <tr>
	 ...
	 <td style="width:10%">
        ...
        <a  href="{{route('quittance_print',['id'=>$var->id ])}}" id="" title="Imprimer quittance" class=""><i class="fas fa-print" style="font-size:15px"></i></a>
