...
<div class="container-fluid" id="container-wrapper">
    <div class="col-lg-12">
    <h2 class="text-center alert alert-secondary">Acquéreur - Ajouter</h2>
              <div class="card mb-4">
 ...
 <a href="javascript:window.history.go(-1)" class="btn btn-default"><i class="fas fa-arrow-circle-left"></i> Retour</a>
             ...
             <div class="col-md-3">
                    <div class="form-group">
                        <strong>Type acquereur<b style="color: red;">*</b></strong>
 ...
 <form  name="form_locataire" id="" method="POST" action="{{ route('store_acquereur') }}" enctype="multipart/form-data">
        {{ csrf_field() }}
        <!--  ************************* personne physique **********************************************  -->
        <input type="hidden" name="locataire_id" id="">
        <input type="hidden" name="type_locataire" id="type_locataire" value="personne physique">
        <input type="hidden" name="acquereur" id="acquereur" value="1">
...
<div class="row">
    ...
    <div class="col-md-3">
        ...
        <div class="col-md-5" id="photo_disp">
                <div class="form-group">
 ...
 <form  name="form_locataire" method="POST" action="{{ route('store_acquereur') }}" enctype="multipart/form-data">
        {{ csrf_field() }}
