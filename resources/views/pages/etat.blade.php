...
<div class="container-fluid" id="container-wrapper">
    ...
    <div class="col-lg-12">
    <h2 class="text-center alert alert-secondary">Etat des lieux - Bailleur & Locataire</h2>
              <div class="card mb-4">
...
<div class="modal fade bd-example-modal-xl" id="modalEtat" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-header">
      ...
      <form name="form_facture_rech_locataire" method="POST"  id="form_facture_rech_locataire" class="form">

    <div class="col-md-12">
        <div class="form-group">

	
            <select class="form-control" id="locataire_rech_id" style="margin:auto; width:30%"  name="locataire_rech_id"  required>
...
<form  name="formEtat1" id="formEtat1" action="{{ url('etat-store') }}" method="POST" >
