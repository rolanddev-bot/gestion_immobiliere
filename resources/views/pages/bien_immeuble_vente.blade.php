...
@endif
    ...
    <div class="col-lg-12">
        <h2 class="text-center alert"  style="background-color:#A9A9A9">Bien - Immeubles Vente </h2>
              <div class="card mb-4">
...
<p align="center">
 <a href="{{ url('bien_vente') }}" class="btn">Terrain</a> |
...
<a href="{{ url('bien_commerce_vente') }}" class="btn">Commerce</a>
   ...
   <a href="{{ url('bien/4/catvente') }}" class="text-center btn btn-success btn-lg" style="font-size:15px" data-target="#"><i class="fas fa-fw fa-plus-square"></i>Nouveau</a>
   <br> <br>
