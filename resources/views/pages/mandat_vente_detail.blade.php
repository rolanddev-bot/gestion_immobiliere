...
<div class="container-fluid" id="container-wrapper">
    ...
    <h2  @if($mandat->archiver == 1) class="text-center alert " style="background-color:darksalmon" @else class="text-center alert alert-secondary" @endif>Mandat Vente  @if($mandat->archiver == 1) archivé @endif - Détail </h2>
...
<p>
   ...
   <a href="{{ url('mandat_vente')}}" class="btn btn-default"><i class="fas fa-arrow-circle-left"></i> Liste</a>
   |
   <a href="{{ url('mandat_vente_edit/'.$mandat->id.'/edit')}}" class="" style=""><i class="fas fa-fw fa-edit" style="font-size:15px"></i>Editer</a>
</p>
