...
<div class="container-fluid" id="container-wrapper">
    <div class="col-lg-12">
    <h2 class="text-center alert alert-secondary">Acquéreur - Modifier</h2>
              <div class="card mb-4">
...
<form  name="form_propietaire" id="" method="POST" action="{{ route('update_acquereur') }}" enctype="multipart/form-data">
        {{ csrf_field() }}
