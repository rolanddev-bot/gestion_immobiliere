...
<html lang="en">
    ...
    <div class="container"  
       <center>   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <img style="width: 300px; height:300px"   src="{{ url('assets/img/logo_sini.png') }}" >
      <br><br>

     <img  align="center" src="{{ url('assets/img/img1_habitation.png') }}" ></center> 
    </div><br><br>

    <div class="container1">
        <p style="text-align: center;"> <h2>MANDAT DE GESTION IMMOBILIERE</h2> </p>
        <p style="text-align: center;"> <h3>BIENS A USAGE D’HABITATION</h3> </p>
    ...
    <div>
        ...
        dont le siège social est à {{ $agence->adresse }} , immatriculée au Registre de Commerce et du
         ...
         <p>D’UNE PART</p>
         <p>@foreach($proprietaire as $prop) {{ $prop->proprietaire->nom.' '.$prop->proprietaire->prenom }} @endforeach
    ...
    <div>
     ...
     <p>Le Mandant confère par le présent mandat au Mandataire, qui l’accepte, de gérer tant activement que passivement les biens et droits immobiliers lui appartenant et dont les caractéristiques sont les suivantes :</p>
     <u>Type de biens</u>  : &nbsp;  <span >{{ $mandats->bien->typebien->libelle }}</span><br>
     <u>Adresse</u>  : &nbsp;  <span >{{ $mandats->bien->adresse }}</span><br>
     <u>Usage</u>  : &nbsp;  <span >Habitation</span><br>
    ...
    <div>  <!-- il y une mise a jour de montant içi -->
      <h5>ARTICLE 2 : LOYER CONVENU</h5>
      <p>Le loyer mensuel de base est de {{ separer($loyer,3) }} francs CFA. Le Mandant déclare, sous sa responsabilité, ne faire l’objet d’aucune procédure de saisie immobilière. Le Mandataire sera seul habilité en droit et en fait à percevoir les loyers, charges et prestations auprès des locataires. </p>
       <br><br>
    ...
    <p>En rémunération des services énumérés ci-dessus, à compter de la prise d’effet des présentes, le Mandataire aura le droit de facturer par mois aux locataires retenus pour jouir des lieux un montant qui ne saurait être
     supérieur à {{ $mandats->honnoraire }}% du montant du loyer mensuel brut. Cette rémunération qui représente ses honoraires est supposée toute taxe comprise. Ces honoraires s’entendent pour une administration générale normale du bien immobilier.
      Ces honoraires ne couvrent pas les frais engagés par le Mandataire à l’occasion du recouvrement des sommes non payées à leur échéance par les locataires.  </p>
   </div> <br> <br><br> <br> <br>
   ...
   <div class="container">
    <center><img  src="{{ public_path('assets/img/img3.PNG') }}" ></center> 
        ...
        <p>Le présent mandat de gestion est donné pour une durée de {{'0'.$mandat_habis->duree}} ans qui prendra effet à compter
            du {{ date('d-m-Y', strtotime($mandat_habis->date_prise_effet)) }}. Il se renouvellera ensuite, par tacite reconduction, par période triennale.
             Les parties pourront résilier le contrat à l’issue de chaque période triennale en signifiant leur
              intention, par lettre recommandée avec accusé de réception ou par courrier contre décharge ou encore
               ...
               reconductions triennales. Le mandat se terminera, en tout état de cause, par la perte de son objet.
                Des frais de clôture de dossier d’un montant de {{ separer($mandat_habis->frais_cloture,3) }} francs CFA seront perçus
