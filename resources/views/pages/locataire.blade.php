...
<div class="container-fluid" id="container-wrapper">
    ...
    <div class="col-lg-12">
    <h2 class="text-center alert alert-secondary">Locataire</h2>
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
<a href="{{ url('locataire-create') }}" class="text-center btn btn-success btn-lg" style="font-size:15px;">
...
@endif
                ...
                <div class="table-responsive p-3">
                  ...
                  <table class="table align-items-center table-flush table-hover" id="dataTablelocataire">
                    ...
                    @foreach($locataire as $loca)

                   <tr style="font-size: 13px;">

 <td>
 <a href="{{ url('locataire/'.$loca->id)}}" title="Voir détail">
@if($loca->photo != 'aucun')
...
@endif
 ...
 <td>
 <a href="{{ url('locataire/'.$loca->id)}}" title="Voir détail">
 {{ $loca->nom.' '.$loca->prenom}}  @if($loca->nom_societe != '') {{ $loca->nom_societe }} @endif
 </a>
 </td>
...
<td>
<a href="{{ url('locataire/'.$loca->id.'/edit') }}" id="" data-client="{{$loca->client}}" data-locataire="{{$loca->locataire}}"
    data-type_piece="{{$loca->type_piece}}" data-numero_piece="{{$loca->numero_piece}}"
    data-date_naissance="{{$loca->date_naissance}}" data-mobile2="{{$loca->mob2}}" data-mobile1="{{$loca->mob1}}"
    data-sexe="{{$loca->sexe}}" data-adresse="{{ $loca->adresse }}" data-id="{{ $loca->id }}"
    data-photo="{{ $loca->photo }}"  data-email="{{ $loca->autres}}" data-nom="{{$loca->nom}}"
    data-type_acquereur="{{$loca->type_locataire_acq}}" data-prenom="{{$loca->prenom}}" data-adresse_representant_loc=""
    data-contact2_representant_loc="{{$loca->contact2_representant}}"
    data-contact1_representant_loc="{{$loca->contact1_representant}}" data-nom_representant_loc="{{$loca->nom_representant}}"
    data-numero_registre_loc="{{$loca->numero_registre}}" data-telephone_societe_loc="{{$loca->telephone_societe}}"
    data-adresse_societe_loc="{{$loca->adresse_societe}}" data-nom_societe_loc="{{$loca->nom_societe}}" class="">
<i class="fas fa-fw fa-edit"></i></a>

<a href="javascript:void(0)" id="archiver_locataire" data-archiver="{{ $loca->archiver }}" data-id="{{ $loca->id }}" title="Archiver" class="">
