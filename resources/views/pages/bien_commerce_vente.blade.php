...
@endif
    ...
    <div class="col-lg-12">
        <h2 class="text-center alert"  style="background-color:#A9A9A9">Bien - Commerces Vente </h2>
              <div class="card mb-4">
...
<a href="{{ url('bien_immeuble_vente') }}" class="btn">Immeuble</a>
   ...
   <a href="{{ url('bien/5/catvente') }}" class="text-center btn btn-success btn-lg" style="font-size:15px" data-target="#"><i class="fas fa-fw fa-plus-square"></i>Nouveau</a>
   <br> <br>
