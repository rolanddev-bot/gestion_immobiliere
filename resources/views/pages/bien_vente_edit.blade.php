...
<div class="container-fluid" id="container-wrapper">
    <div class="col-lg-12">
    <h2 class="text-center alert alert-secondary">Bien - {{ $typebien->libelle }} - Modifierdd</h2>
              <div class="card mb-4">
...
<form  name="form_bien" id="form_bien" method="POST" action="{{route('bien_vente_update')}}">
        {{ csrf_field() }}
