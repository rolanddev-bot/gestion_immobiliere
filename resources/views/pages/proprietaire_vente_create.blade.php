...
<form  name="form_propietaire" id="div_physique" method="POST" action="{{ url('proprietaire_v_store') }}" enctype="multipart/form-data">
        {{ csrf_field() }}
        <!--  *************************CHAMPS NOM PRENOM ET EMAIL**********************************************  -->
        <input type="hidden" name="user_id" id="">
        <input type="hidden" name="en_vente" id="" value="1">
...
<form  name="form_propietaire" id="div_moral" method="POST" action="{{ url('proprietaire_v_store') }}" enctype="multipart/form-data">
        {{ csrf_field() }}
