...
<form  name="form_bien" id="form_bien" method="POST" action="{{ route('bienstore') }}">
        {{ csrf_field() }}
  ...
  @if($typebien->id !=4)
   ...
   <div class="col-md-1">
	   ...
	   <strong>Non meublé </strong>
		   ...
		   <input type="checkbox" class="form-control" name="non_meuble" id="non_meuble"  value="1">
		   <div class="alert-danger" id="meubleError"></div>
	   </div>
   </div>
	@endif
@endif
  ...
  @if($typebien->id !=4)
   <div class="col-md-1">
	<div class="form-group">
		<strong>Libre</strong>
		<input type="checkbox" class="form-control" name="libre" id="libre" value="1">
	...
	<div class="form-group">
		...
		<input type="checkbox" class="form-control" name="occupe" id="occupe" value="1">
...
@endif
	...
	<div class="form-group">
	   <strong> &nbsp;&nbsp; Non viabilisé </strong>
		   <input type="checkbox" class="form-control" name="non_viabilise" id="non_viabilise"  value="1">
		   <div class="alert-danger" id="meubleError"></div>
	   </div>
	</div>
		@endif
