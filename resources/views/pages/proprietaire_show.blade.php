...
<div class="container-fluid" id="container-wrapper">
 ...
 <p>
   ...
   <a href="{{ url('proprietaire')}}" class="btn btn-default"><i class="fas fa-arrow-circle-left"></i> Liste</a>
   |
   <a href="{{ url('proprietaire/'.$prop->id.'/edit')}}" class="" style=""><i class="fas fa-fw fa-edit" style="font-size:15px"></i>Editer</a>
</p>
...
<p align="center">
 ...
 <div class="row">
    ...
    <div class="col-md-4">
        ...
        Profession:  <span class="text-primary">{{ $prop->profession  }}</span><br>
        ...
        Etablie le:  <span class="text-primary">{{ $prop->etablie_le }}</span><br>
        ...
        Domicilié à:  <span class="text-primary">{{ $prop->domicile_a  }}</span><br>
