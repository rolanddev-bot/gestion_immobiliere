...
<div class="container-fluid" id="container-wrapper">
    ...
    <div class="col-lg-12">
    <h2 class="text-center alert alert-secondary">Acquéreur</h2>
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
<a href="{{ url('create_acquereur') }}" class="text-center btn btn-success btn-lg" style="font-size:15px;">
...
@endif
            ...
            <td>
                   <a href="{{route('show_acquereur',['id'=> $loca->id])}}" title="Voir détail">
                @if($loca->photo != 'aucun')
            ...
            <td>
            <a href="{{route('edit_acquereur',['id'=> $loca->id])}}" id="" class=""> <i class="fas fa-fw fa-edit"></i></a>

            <a href="javascript:void(0)" id="archiver_acquereur" data-archiver="{{ $loca->archiver }}" data-id="{{ $loca->id }}" title="Archiver" class="">
